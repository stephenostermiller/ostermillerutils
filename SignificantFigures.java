 ...
 *
 * <p>
 * Example of using this class to muliply numbers and display the result 
...
public class SignificantFigures extends Number {
   ...
   public SignificantFigures(short number){
     ...
     * result could be zero with some number of significant digits.  Its is safest
     ...
     * zeros.  The decimal place has not 
     ...
     * State in which a possible sign and
     * at least one non-zero digit
     * has been read.  The decimal place has not 
     * been encountered yet.
     */
